...
class RecruitmentMediaViewTestCase(APITestCase):
    """
    Test case for `RecruitmentMediaView`.
    """
    ...
    def test_get_recruitment_media_by_builder_user(self) -> None:
        """
        `builder`グループのユーザーが「求人媒体」を取得できるかテスト
        """
        # `builder`グループユーザーで認証
        self.client.force_authenticate(user=self.builder_user)

        url = reverse("recruitment_media")  # `urls.py`で定義された名前を使用
        ...
        # 期待される値を直接定義
        expected_choices = [
            {"value": 1, "label": "BIZREACH"},
            {"value": 2, "label": "dodaダイレクト"},
            {"value": 3, "label": "Green"},
            {"value": 4, "label": "Wantedly"},
            {"value": 5, "label": "リクルート ダイレクトスカウト"},
            {"value": 6, "label": "マイナビ転職"},
            {"value": 7, "label": "エン転職ダイレクト"},
            {"value": 8, "label": "AMBI"},
            {"value": 9, "label": "Linkedin"},
            {"value": 10, "label": "paiza"},
            {"value": 11, "label": "OpenWork"},
            {"value": 99, "label": "その他"}
        ]
    ...
    def test_get_recruitment_media_by_normal_user(self) -> None:
        """
