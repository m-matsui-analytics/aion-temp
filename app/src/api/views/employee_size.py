...
from base.models import EmployeeSize


class EmployeeSizeView(views.APIView):
    """
    選択肢: 従業員数のビュー
    """
    ...
    def get(self, request: Request, *args: tuple, **kwargs: dict) -> Response:  # noqa: ARG002
        """取得"""
        choices = [{"value": choice.value, "label": choice.label} for choice in EmployeeSize]  # noqa: E501
